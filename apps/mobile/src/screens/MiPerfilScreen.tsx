    ...
    return (
      <View style={{ flex: 1, backgroundColor: t.bg }}>
        ...
        <View style={{ paddingTop: spacing.md }}>
          ...
          <Pressable style={s.gRow} onPress={() => Linking.openURL('mailto:obrador.ar@gmail.com?subject=Ayuda Obrador')}>
    ...
    <View style={{ flex: 1, backgroundColor: t.bg }}>
      ...
      >
        ...
        <View style={s.tiles}>
          ...
          <Tile icon="phone" label="Ayuda" onPress={() => Linking.openURL('mailto:obrador.ar@gmail.com?subject=Ayuda Obrador')} />
        </View>
...
const styles = (t: Theme) =>
  StyleSheet.create({
    ...
    completarNombreTxt: { color: t.sel, fontSize: 14, fontWeight: '800' },
    ...
    oficioChipOn: { backgroundColor: t.sel, borderColor: t.sel },
    oficioChipTxt: { color: t.text2, fontSize: 13, fontWeight: '700' },
    oficioChipTxtOn: { color: t.surface },
